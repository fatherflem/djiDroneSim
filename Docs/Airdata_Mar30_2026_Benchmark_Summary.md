...
| forward_step | compared | medium | estimated_from_limited_segments | 0.08 | 2.649 | 7.333 | 0.49 | 2.884 | too_aggressive_provisional_input_amplitude |
| lateral_right | compared | high | directly_measured | 0.08 | 3.001 | 6.56 | -0.02 | 2.432 | too_aggressive |
| lateral_left | no_real_data | - | - | - | - | - | - | - | insufficient data |
| climb | compared | medium | estimated_from_limited_segments | -0.19 | -1.188 | 4.25 | 1.07 | 1.029 | too_sluggish_provisional_input_amplitude |
| descent | compared | medium | estimated_from_limited_segments | -0.107 | -1.035 | 6.0 | 1.06 | 1.859 | too_sluggish_provisional_input_amplitude |
| yaw_right | compared | high | directly_measured | -0.2 | -6.602 | 394.95 | 1.3 | 67.269 | too_sluggish |
| yaw_left | compared | high | directly_measured | -0.21 | 3.549 | 495.909 | 1.3 | 61.532 | too_aggressive |
